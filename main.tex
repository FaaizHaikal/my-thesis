...
Z_c = \frac{-T_z}{r_{13} x + r_{23} y + r_{33}}
\end{equation}
...
$O_3$ & (746.7.3, 300.5) & 3.3 (1.1\%) & -3.3 (1.1\%) & 0.5 (0.0\%) \\
...
\midrule
$O_1$ & (552.9, 344.4) & 9.6 & (2.9, -5.6) \\
$O_2$ & (650.4, 188.9) & 23.7 & (0.4, -11.1) \\
$O_3$ & (748.6, 299.3) & 12.1 & (-1.4, -0.7) \\
$O_6$ & (940.2, 197.3) & 54.1 & (40.2, 7.3) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{align*}
E_r &= 0.0007 \ \text{deg/cm}, \\
K_\theta &= 0.1068 \ \text{deg}^2/\text{cm}, \\
E_t &= -1.8142\%, \\
K_\rho &= 0.346958 \ \text{cm}.
\end{align*}
...
performance across most objects. The ball ($O_1$) and penalty marker ($O_3$) 
exhibit low mean errors, indicating that the system remains reliable for 
nearby and mid-range objects during walking. Larger errors are observed for 
distant objects such as the goalpost ($O_6$), which is consistent 
with the limitations explained in the static evaluation.
