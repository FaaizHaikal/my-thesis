...
\begin{itemize}
    ...
    \item $K$: The camera intrinsic matrix, parameters unique to specific camera hardware,  
               including the focal length ($f$) and the principal point coordinates ($p_x, p_y$).
...
calibration library to estimate the focal length ($f$) and principal point 
...
broadcasts coordinate transformations using the \texttt{tf2} library. By consuming live joint encoders 
and IMU data, the package provides real-time coordinate transformations
